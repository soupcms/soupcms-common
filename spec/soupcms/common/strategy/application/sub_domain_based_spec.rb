...
describe SoupCMS::Common::Strategy::Application::SubDomainBased do

  let(:app_strategy) { SoupCMS::Common::Strategy::Application::SubDomainBased.new(Rack::Request.new(Rack::MockRequest.env_for('http://soupcms-test.example.com:8080/posts/slug/my-first-blog-post?include=drafts'))) }
